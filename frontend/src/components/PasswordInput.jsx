...
export const PasswordInput = ({ name, password, setPassword, handleBlur, touched, errors, placeholder }) => {
  ...
  return (
    <div className="relative w-full">
      ...
      >
        {showPassword ? (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="w-4 h-4 fill-gray-500">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="w-4 h-4 fill-gray-500">
